/**
 * @module v_gravidogrammprocessSchema
 */

/**
 * @typedef {Object} module:v_gravidogrammprocessSchema.editorObj
...
/**
 * @typedef {Object} module:v_gravidogrammprocessSchema.attachedMediaObj
...
/**
 * @typedef {Object} module:v_gravidogrammprocessSchema.medDataObj
...
/**
 * @typedef {Object} module:v_gravidogrammprocessSchema.v_gravidogrammprocess
 * @property {String} actType - 
 * @property {Array.<module:v_gravidogrammprocessSchema.medDataObj>} medData - 
 * @property {Array.<String>} attachments - 
 * @property {Array.<module:v_gravidogrammprocessSchema.attachedMediaObj>} attachedMedia - 
 ...
 * @property {Array.<module:v_gravidogrammprocessSchema.editorObj>} editor - 
