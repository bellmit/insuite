/**
 * @module v_kbvutilitySchema
 */

/**
 * @typedef {Object} module:v_kbvutilitySchema.utRemedy2ListObj
...
/**
 * @typedef {Object} module:v_kbvutilitySchema.utRemedy1ListObj
 * @property {String} name - 
 * @property {String} type - 
 * @property {Boolean} groupTherapyAble - 
 * @property {Number} seasons - 
...
/**
 * @typedef {Object} module:v_kbvutilitySchema.utAgreementApprovedForInsuranceObj
...
/**
 * @typedef {Object} module:v_kbvutilitySchema.editorObj
 * @property {String} name - 
...
/**
 * @typedef {Object} module:v_kbvutilitySchema.attachedMediaObj
...
/**
 * @typedef {Object} module:v_kbvutilitySchema.v_kbvutility
 * @property {Array.<String>} attachments - 
 * @property {Array.<module:v_kbvutilitySchema.attachedMediaObj>} attachedMedia - 
 ...
 * @property {Array.<module:v_kbvutilitySchema.editorObj>} editor - 
 ...
 * @property {Array.<module:v_kbvutilitySchema.utAgreementApprovedForInsuranceObj>} utAgreementApprovedForInsurance - 
 ...
 * @property {Array.<module:v_kbvutilitySchema.utRemedy1ListObj>} utRemedy1List - 
 * @property {Array.<module:v_kbvutilitySchema.utRemedy2ListObj>} utRemedy2List - 
