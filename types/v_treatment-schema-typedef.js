/**
 * @module v_treatmentSchema
 */

/**
 * @typedef {Object} module:v_treatmentSchema.omimCodesObj
...
/**
 * @typedef {Object} module:v_treatmentSchema.hierarchyRulesObj
...
/**
 * @typedef {Object} module:v_treatmentSchema.fk5042SetObj
...
/**
 * @typedef {Object} module:v_treatmentSchema.fk5036SetObj
 * @property {String} fk5036 - 
 */


/**
 * @typedef {Object} module:v_treatmentSchema.fk5035SetObj
...
/**
 * @typedef {Object} module:v_treatmentSchema.fk5020SetObj
...
/**
 * @typedef {Object} module:v_treatmentSchema.fk5011SetObj
 * @property {String} fk5011 - 
 */


/**
 * @typedef {Object} module:v_treatmentSchema.fk5012SetObj
 * @property {String} fk5012 - 
 * @property {String} fk5074 - 
 * @property {String} fk5075 - 
 * @property {Array.<module:v_treatmentSchema.fk5011SetObj>} fk5011Set - 
 */


/**
 * @typedef {Object} module:v_treatmentSchema.editorObj
...
/**
 * @typedef {Object} module:v_treatmentSchema.attachedMediaObj
...
/**
 * @typedef {Object} module:v_treatmentSchema.v_treatment
 * @property {String} actType - 
 * @property {String} status - 
 * @property {String} catalogShort - 
 * @property {Number} vat - 
 * @property {Array.<String>} attachments - 
 * @property {Array.<module:v_treatmentSchema.attachedMediaObj>} attachedMedia - 
 ...
 * @property {Array.<module:v_treatmentSchema.editorObj>} editor - 
 ...
 * @property {Array.<module:v_treatmentSchema.fk5012SetObj>} fk5012Set - 
 * @property {String} fk5015 - 
 * @property {String} fk5016 - 
 * @property {String} tsvDoctorNo - 
 * @property {String} fk5018 - 
 * @property {Array.<module:v_treatmentSchema.fk5020SetObj>} fk5020Set - 
 * @property {Array.<module:v_treatmentSchema.fk5035SetObj>} fk5035Set - 
 * @property {Array.<module:v_treatmentSchema.fk5036SetObj>} fk5036Set - 
 * @property {String} fk5038 - 
 * @property {String} fk5010BatchNumber - 
 * @property {Array.<module:v_treatmentSchema.fk5042SetObj>} fk5042Set - 
 * @property {String} treatmentCategory - 
 * @property {Array.<module:v_treatmentSchema.hierarchyRulesObj>} hierarchyRules - 
 ...
 * @property {Array.<module:v_treatmentSchema.omimCodesObj>} omimCodes - 
