/**
 * @module v_dmpdm2Schema
 */

/**
 * @typedef {Object} module:v_dmpdm2Schema.editorObj
...
/**
 * @typedef {Object} module:v_dmpdm2Schema.attachedMediaObj
...
/**
 * @typedef {Object} module:v_dmpdm2Schema.v_dmpdm2
 * @property {String} actType - 
 * @property {string} status - 
 * @property {Array.<String>} attachments - 
 * @property {Array.<module:v_dmpdm2Schema.attachedMediaObj>} attachedMedia - 
 ...
 * @property {Array.<module:v_dmpdm2Schema.editorObj>} editor - 
