/**
 * @module mirroremployeeSchema
 */

/**
 * @typedef {Object} module:mirroremployeeSchema.locationsObj
 * @property {String} _id - 
...
/**
 * @typedef {Object} module:mirroremployeeSchema.addressesObj
...
/**
 * @typedef {Object} module:mirroremployeeSchema.communicationsObj
...
/**
 * @typedef {Object} module:mirroremployeeSchema.accountsObj
...
/**
 * @typedef {Object} module:mirroremployeeSchema.mirroremployee
 * @property {String} title - 
 * @property {String} firstname - 
 * @property {String} nameaffix - 
 * @property {String} middlename - 
 ...
 * @property {Array.<module:mirroremployeeSchema.accountsObj>} accounts - 
 * @property {Boolean} activeState - 
 * @property {Array.<module:mirroremployeeSchema.communicationsObj>} communications - 
 * @property {Array.<module:mirroremployeeSchema.addressesObj>} addresses - 
 * @property {string} type - 
 ...
 * @property {Array.<module:mirroremployeeSchema.locationsObj>} locations - 
