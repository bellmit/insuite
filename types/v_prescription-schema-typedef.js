/**
 * @module v_prescriptionSchema
 */

/**
 * @typedef {Object} module:v_prescriptionSchema.editorObj
...
/**
 * @typedef {Object} module:v_prescriptionSchema.attachedMediaObj
...
/**
 * @typedef {Object} module:v_prescriptionSchema.v_prescription
 * @property {String} actType - 
 * @property {string} status - 
 * @property {Array.<String>} attachments - 
 * @property {Array.<module:v_prescriptionSchema.attachedMediaObj>} attachedMedia - 
 ...
 * @property {Array.<module:v_prescriptionSchema.editorObj>} editor - 
