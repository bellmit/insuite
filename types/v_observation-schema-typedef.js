/**
 * @module v_observationSchema
 */

/**
 * @typedef {Object} module:v_observationSchema.editorObj
...
/**
 * @typedef {Object} module:v_observationSchema.attachedMediaObj
...
/**
 * @typedef {Object} module:v_observationSchema.v_observation
 * @property {String} actType - 
 * @property {Array.<String>} attachments - 
 * @property {Array.<module:v_observationSchema.attachedMediaObj>} attachedMedia - 
 ...
 * @property {Array.<module:v_observationSchema.editorObj>} editor - 
