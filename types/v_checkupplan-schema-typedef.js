/**
 * @module v_checkupplanSchema
 */

/**
 * @typedef {Object} module:v_checkupplanSchema.examinationsObj
 * @property {String} stage - 
 * @property {Date} plannedFrom - 
 * @property {Date} plannedTo - 
 * @property {Date} toleranceFrom - 
 * @property {Date} toleranceTo - 
 * @property {Date} completed - 
 */


/**
 * @typedef {Object} module:v_checkupplanSchema.editorObj
...
/**
 * @typedef {Object} module:v_checkupplanSchema.attachedMediaObj
...
/**
 * @typedef {Object} module:v_checkupplanSchema.v_checkupplan
 * @property {String} actType - 
 * @property {Array.<String>} attachments - 
 * @property {Array.<module:v_checkupplanSchema.attachedMediaObj>} attachedMedia - 
 ...
 * @property {Array.<module:v_checkupplanSchema.editorObj>} editor - 
 ...
 * @property {Array.<module:v_checkupplanSchema.examinationsObj>} examinations - 
 */