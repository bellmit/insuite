/**
 * @module v_amts_scheinSchema
 */

/**
 * @typedef {Object} module:v_amts_scheinSchema.invoiceDataObj
...
/**
 * @typedef {Object} module:v_amts_scheinSchema.fk4256SetObj
...
/**
 * @typedef {Object} module:v_amts_scheinSchema.fk4244SetObj
 * @property {String} fk4244 - 
 * @property {String} fk4246 - 
 * @property {String} fk4246Offset - 
 * @property {String} fk4245 - 
...
/**
 * @typedef {Object} module:v_amts_scheinSchema.fk4251SetObj
 * @property {String} fk4251 - 
 */


/**
 * @typedef {Object} module:v_amts_scheinSchema.fk4235SetObj
 * @property {Date} fk4235 - 
 * @property {Date} fk4247 - 
 * @property {Boolean} fk4250 - 
 * @property {Array.<module:v_amts_scheinSchema.fk4251SetObj>} fk4251Set - 
 * @property {Number} fk4252 - 
 * @property {Number} fk4255 - 
 * @property {String} fk4299 - 
 * @property {Array.<module:v_amts_scheinSchema.fk4244SetObj>} fk4244Set - 
 * @property {Array.<module:v_amts_scheinSchema.fk4256SetObj>} fk4256Set - 
...
/**
 * @typedef {Object} module:v_amts_scheinSchema.editorObj
...
/**
 * @typedef {Object} module:v_amts_scheinSchema.attachedMediaObj
...
/**
 * @typedef {Object} module:v_amts_scheinSchema.v_amts_schein
 * @property {String} actType - 
 * @property {Array.<String>} attachments - 
 * @property {Array.<module:v_amts_scheinSchema.attachedMediaObj>} attachedMedia - 
 ...
 * @property {Array.<module:v_amts_scheinSchema.editorObj>} editor - 
 ...
 * @property {Array.<module:v_amts_scheinSchema.fk4235SetObj>} fk4235Set - 
 ...
 * @property {Array.<module:v_amts_scheinSchema.invoiceDataObj>} invoiceData - 
