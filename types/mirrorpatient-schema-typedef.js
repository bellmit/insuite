/**
 * @module mirrorpatientSchema
 */

/**
 * @typedef {Object} module:mirrorpatientSchema.latestLabDataObj
...
/**
 * @typedef {Object} module:mirrorpatientSchema.latestMedDataObj
...
/**
 * @typedef {Object} module:mirrorpatientSchema.crmTreatmentsObj
...
/**
 * @typedef {Object} module:mirrorpatientSchema.patientTransferObj
...
/**
 * @typedef {Object} module:mirrorpatientSchema.partnerIdsObj
...
/**
 * @typedef {Object} module:mirrorpatientSchema.devicesObj
 * @property {String} key - 
...
/**
 * @typedef {Object} module:mirrorpatientSchema.imagesObj
...
/**
 * @typedef {Object} module:mirrorpatientSchema.affiliatesObj
...
/**
 * @typedef {Object} module:mirrorpatientSchema.insuranceStatusObj
...
/**
 * @typedef {Object} module:mirrorpatientSchema.addressesObj
...
/**
 * @typedef {Object} module:mirrorpatientSchema.communicationsObj
 * @property {String} type - 
...
/**
 * @typedef {Object} module:mirrorpatientSchema.accountsObj
 * @property {String} cardType - 
...
/**
 * @typedef {Object} module:mirrorpatientSchema.mirrorpatient
 ...
 * @property {Array.<module:mirrorpatientSchema.accountsObj>} accounts - 
 * @property {Boolean} activeState - 
 * @property {Array.<module:mirrorpatientSchema.communicationsObj>} communications - 
 * @property {Array.<module:mirrorpatientSchema.addressesObj>} addresses - 
 * @property {String} kbvDob - 
 * @property {Array.<module:mirrorpatientSchema.insuranceStatusObj>} insuranceStatus - 
 ...
 * @property {Array.<module:mirrorpatientSchema.affiliatesObj>} affiliates - 
 * @property {Array.<module:mirrorpatientSchema.imagesObj>} images - 
 ...
 * @property {Array.<module:mirrorpatientSchema.devicesObj>} devices - 
 ...
 * @property {Array.<module:mirrorpatientSchema.partnerIdsObj>} partnerIds - 
 ...
 * @property {module:mirrorpatientSchema.patientTransferObj} patientTransfer - 
 * @property {String} importId - 
 * @property {Array.<String>} crmTags - 
 * @property {Array.<module:mirrorpatientSchema.crmTreatmentsObj>} crmTreatments - 
 ...
 * @property {Array.<module:mirrorpatientSchema.latestMedDataObj>} latestMedData - 
 * @property {Array.<module:mirrorpatientSchema.latestLabDataObj>} latestLabData - 
