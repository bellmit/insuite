/**
 * @module v_processSchema
 */

/**
 * @typedef {Object} module:v_processSchema.editorObj
...
/**
 * @typedef {Object} module:v_processSchema.attachedMediaObj
...
/**
 * @typedef {Object} module:v_processSchema.v_process
 * @property {String} actType - 
 * @property {Array.<String>} attachments - 
 * @property {Array.<module:v_processSchema.attachedMediaObj>} attachedMedia - 
 ...
 * @property {Array.<module:v_processSchema.editorObj>} editor - 
