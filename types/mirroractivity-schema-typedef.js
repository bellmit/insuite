/**
 * @module mirroractivitySchema
 */

/**
 * @typedef {Object} module:mirroractivitySchema.linkedTreatmentsObj
...
/**
 * @typedef {Object} module:mirroractivitySchema.eTSAdditionalQualificationsObj
 * @property {String} code - 
...
/**
 * @typedef {Object} module:mirroractivitySchema.medDataObj
...
/**
 * @typedef {Object} module:mirroractivitySchema.participantsObj
...
/**
 * @typedef {Object} module:mirroractivitySchema.ut2ConductionSymptomsObj
 * @property {String} code - 
...
/**
 * @typedef {Object} module:mirroractivitySchema.ut2AgreementObj
 * @property {String} type - 
...
/**
 * @typedef {Object} module:mirroractivitySchema.ut2Remedy2ListObj
 * @property {String} name - 
 * @property {String} type - 
...
/**
 * @typedef {Object} module:mirroractivitySchema.ut2Remedy1ListObj
 * @property {String} name - 
 * @property {String} type - 
 * @property {String} text - 
 * @property {Number} units - 
...
/**
 * @typedef {Object} module:mirroractivitySchema.utRemedy2ListObj
 * @property {String} name - 
 * @property {String} type - 
...
/**
 * @typedef {Object} module:mirroractivitySchema.utRemedy1ListObj
 * @property {String} name - 
 * @property {String} type - 
 * @property {Boolean} groupTherapyAble - 
 * @property {Number} seasons - 
...
/**
 * @typedef {Object} module:mirroractivitySchema.utAgreementApprovedForInsuranceObj
...
/**
 * @typedef {Object} module:mirroractivitySchema.otAppliedSetObj
...
/**
 * @typedef {Object} module:mirroractivitySchema.dispensedItemsObj
...
/**
 * @typedef {Object} module:mirroractivitySchema.phAMRContentObj
 * @property {String} title - 
 * @property {String} text - 
...
/**
 * @typedef {Object} module:mirroractivitySchema.phARVContentObj
 * @property {String} title - 
...
/**
 * @typedef {Object} module:mirroractivitySchema.phIngrObj
...
/**
 * @typedef {Object} module:mirroractivitySchema.omimCodesObj
...
/**
 * @typedef {Object} module:mirroractivitySchema.hierarchyRulesObj
...
/**
 * @typedef {Object} module:mirroractivitySchema.fk5042SetObj
...
/**
 * @typedef {Object} module:mirroractivitySchema.fk5036SetObj
 * @property {String} fk5036 - 
 */


/**
 * @typedef {Object} module:mirroractivitySchema.fk5035SetObj
...
/**
 * @typedef {Object} module:mirroractivitySchema.fk5020SetObj
...
/**
 * @typedef {Object} module:mirroractivitySchema.fk5011SetObj
 * @property {String} fk5011 - 
 */


/**
 * @typedef {Object} module:mirroractivitySchema.fk5012SetObj
 * @property {String} fk5012 - 
 * @property {String} fk5074 - 
 * @property {String} fk5075 - 
 * @property {Array.<module:mirroractivitySchema.fk5011SetObj>} fk5011Set - 
 */


/**
 * @typedef {Object} module:mirroractivitySchema.invoiceDataObj
...
/**
 * @typedef {Object} module:mirroractivitySchema.fk4256SetObj
...
/**
 * @typedef {Object} module:mirroractivitySchema.fk4244SetObj
 * @property {String} fk4244 - 
 * @property {String} fk4246 - 
 * @property {String} fk4246Offset - 
 * @property {String} fk4245 - 
...
/**
 * @typedef {Object} module:mirroractivitySchema.fk4251SetObj
 * @property {String} fk4251 - 
 */


/**
 * @typedef {Object} module:mirroractivitySchema.fk4235SetObj
 * @property {Date} fk4235 - 
 * @property {Date} fk4247 - 
 * @property {Boolean} fk4250 - 
 * @property {Array.<module:mirroractivitySchema.fk4251SetObj>} fk4251Set - 
 * @property {Number} fk4252 - 
 * @property {Number} fk4255 - 
 * @property {String} fk4299 - 
 * @property {Array.<module:mirroractivitySchema.fk4244SetObj>} fk4244Set - 
 * @property {Array.<module:mirroractivitySchema.fk4256SetObj>} fk4256Set - 
...
/**
 * @typedef {Object} module:mirroractivitySchema.linkedContentsObj
...
/**
 * @typedef {Object} module:mirroractivitySchema.linkedTimestampsObj
 * @property {String} receiptId - 
...
/**
 * @typedef {Object} module:mirroractivitySchema.linkedEmployeesObj
 * @property {String} receiptId - 
 * @property {String} name - 
...
/**
 * @typedef {Object} module:mirroractivitySchema.kimSignedByObj
 * @property {Date} timestamp - 
 * @property {String} name - 
 * @property {String} employeeId - 
 */
...
/**
 * @typedef {Object} module:mirroractivitySchema.relatedCodesObj
 * @property {Boolean} checked - 
 * @property {String} title - 
 * @property {String} seq - 
 * @property {Boolean} F - 
...
/**
 * @typedef {Object} module:mirroractivitySchema.editorObj
 * @property {String} name - 
 * @property {String} employeeNo - 
 * @property {String} initials - 
 */
...
/**
 * @typedef {Object} module:mirroractivitySchema.attachedMediaObj
...
/**
 * @typedef {Object} module:mirroractivitySchema.mirroractivity
 * @property {Array.<String>} attachments - 
 * @property {Array.<module:mirroractivitySchema.attachedMediaObj>} attachedMedia - 
 ...
 * @property {Array.<module:mirroractivitySchema.editorObj>} editor - 
 ...
 * @property {Array.<module:mirroractivitySchema.relatedCodesObj>} relatedCodes - 
 * @property {Array.<String>} icds - 
 * @property {Array.<String>} icdsExtra - 
 * @property {String} kimState - 
 * @property {Array.<module:mirroractivitySchema.kimSignedByObj>} kimSignedBy - 
 ...
 * @property {Array.<module:mirroractivitySchema.linkedEmployeesObj>} linkedEmployees - 
 * @property {Array.<module:mirroractivitySchema.linkedTimestampsObj>} linkedTimestamps - 
 ...
 * @property {Array.<module:mirroractivitySchema.linkedContentsObj>} linkedContents - 
 * @property {String} insuranceName - 
 ...
 * @property {Array.<module:mirroractivitySchema.fk4235SetObj>} fk4235Set - 
 * @property {String} fk4219 - 
 * @property {Array.<String>} continuousMedications - 
 * @property {String} patientVersionId - 
 * @property {Array.<module:mirroractivitySchema.invoiceDataObj>} invoiceData - 
 ...
 * @property {Array.<module:mirroractivitySchema.fk5012SetObj>} fk5012Set - 
 * @property {String} fk5015 - 
 * @property {String} fk5016 - 
 * @property {String} tsvDoctorNo - 
 * @property {String} fk5018 - 
 * @property {Array.<module:mirroractivitySchema.fk5020SetObj>} fk5020Set - 
 * @property {Array.<module:mirroractivitySchema.fk5035SetObj>} fk5035Set - 
 * @property {Array.<module:mirroractivitySchema.fk5036SetObj>} fk5036Set - 
 * @property {String} fk5038 - 
 * @property {String} fk5010BatchNumber - 
 * @property {Array.<module:mirroractivitySchema.fk5042SetObj>} fk5042Set - 
 * @property {String} treatmentCategory - 
 * @property {Array.<module:mirroractivitySchema.hierarchyRulesObj>} hierarchyRules - 
 ...
 * @property {Array.<module:mirroractivitySchema.omimCodesObj>} omimCodes - 
 ...
 * @property {Array.<module:mirroractivitySchema.phIngrObj>} phIngr - 
 ...
 * @property {Array.<module:mirroractivitySchema.phARVContentObj>} phARVContent - 
 * @property {Array.<module:mirroractivitySchema.phAMRContentObj>} phAMRContent - 
 ...
 * @property {Array.<module:mirroractivitySchema.dispensedItemsObj>} dispensedItems - 
 ...
 * @property {Array.<module:mirroractivitySchema.otAppliedSetObj>} otAppliedSet - 
 ...
 * @property {Array.<module:mirroractivitySchema.utAgreementApprovedForInsuranceObj>} utAgreementApprovedForInsurance - 
 ...
 * @property {Array.<module:mirroractivitySchema.utRemedy1ListObj>} utRemedy1List - 
 * @property {Array.<module:mirroractivitySchema.utRemedy2ListObj>} utRemedy2List - 
 ...
 * @property {Array.<module:mirroractivitySchema.ut2Remedy1ListObj>} ut2Remedy1List - 
 * @property {Array.<module:mirroractivitySchema.ut2Remedy2ListObj>} ut2Remedy2List - 
 * @property {String} ut2TreatmentRelevantDiagnosisText - 
 * @property {String} ut2AgreementType - 
 * @property {Array.<module:mirroractivitySchema.ut2AgreementObj>} ut2Agreement - 
 ...
 * @property {Array.<module:mirroractivitySchema.ut2ConductionSymptomsObj>} ut2ConductionSymptoms - 
 ...
 * @property {Date} start - 
 * @property {Date} end - 
 * @property {Array.<module:mirroractivitySchema.participantsObj>} participants - 
 ...
 * @property {Array.<module:mirroractivitySchema.medDataObj>} medData - 
 ...
 * @property {Array.<module:mirroractivitySchema.eTSAdditionalQualificationsObj>} eTSAdditionalQualifications - 
 ...
 * @property {Array.<module:mirroractivitySchema.linkedTreatmentsObj>} linkedTreatments - 
