...
/**
 * @typedef {Object} module:v_caveSchema.editorObj
...
/**
 * @typedef {Object} module:v_caveSchema.attachedMediaObj
...
/**
 * @typedef {Object} module:v_caveSchema.v_cave
 * @property {String} actType - 
 * @property {Array.<String>} attachments - 
 * @property {Array.<module:v_caveSchema.attachedMediaObj>} attachedMedia - 
 ...
 * @property {Array.<module:v_caveSchema.editorObj>} editor - 
