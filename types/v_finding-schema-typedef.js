/**
 * @module v_findingSchema
 */

/**
 * @typedef {Object} module:v_findingSchema.editorObj
...
/**
 * @typedef {Object} module:v_findingSchema.attachedMediaObj
...
/**
 * @typedef {Object} module:v_findingSchema.v_finding
 * @property {String} actType - 
 * @property {Array.<String>} attachments - 
 * @property {Array.<module:v_findingSchema.attachedMediaObj>} attachedMedia - 
 ...
 * @property {Array.<module:v_findingSchema.editorObj>} editor - 
