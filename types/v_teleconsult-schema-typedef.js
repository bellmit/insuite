/**
 * @module v_teleconsultSchema
 */

/**
 * @typedef {Object} module:v_teleconsultSchema.participantsObj
...
/**
 * @typedef {Object} module:v_teleconsultSchema.editorObj
...
/**
 * @typedef {Object} module:v_teleconsultSchema.attachedMediaObj
...
/**
 * @typedef {Object} module:v_teleconsultSchema.v_teleconsult
 * @property {String} actType - 
 * @property {Array.<String>} attachments - 
 * @property {Array.<module:v_teleconsultSchema.attachedMediaObj>} attachedMedia - 
 ...
 * @property {Array.<module:v_teleconsultSchema.editorObj>} editor - 
 ...
 * @property {Date} start - 
 * @property {Date} end - 
 * @property {Array.<module:v_teleconsultSchema.participantsObj>} participants - 
 */