...
DayGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		var timeText;
		var titleHtml;
		var dcschedule = event.dc,
			cornerSmallHeight = "10px",
			cornerWidth = "25px",
			cornerColor;
		if (dcschedule) {
			dcschedule = event.dc.schedule;
			cornerColor = dcschedule.cornerColor;
		}
		...
		return '<a class="' + classes.join(' ') + '"' +
			...
			'>' +
			   '<div class="fc-triangle" style="border-right-color: ' + cornerColor + ';' +
			   'border-right-width: ' + cornerWidth + ';' +
			   'border-bottom-width: ' + cornerSmallHeight +';' +
			   '"></div>'+
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		return '<a class="' + classes.join(' ') + '"' +
			...
			'>' +
			    '<div class="fc-triangle" style="border-right-color: ' + cornerColor + ';' +
			   'border-right-width: ' + cornerWidth + ';' +
			   'border-bottom-width: ' + cornerHeight +';' +
			   '"></div>' +
				'<div class="fc-content">' +
					(timeText ?
						'<div class="fc-time"' +
...
function Calendar_constructor(element, overrides) {
	...
	function refetchEvents() { // can be called as an API method
		// TODO: MOJ-2639 https://code.google.com/p/fullcalendar/issues/detail?id=2293
