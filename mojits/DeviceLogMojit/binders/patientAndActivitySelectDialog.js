...
YUI.add( 'dcpatientandactivityselect', function( Y ) {
        ...
        Y.extend( PatientAndActivitySelectModel, KoViewModel.getDisposable(), {
            ...
            initializer: function BinderViewModel_initializer() {
                ...
                self.chooseActivityI18n = i18n( 'DeviceLogMojit.patientAndActivitySelectDlg.labels.chooseActivity' );
            ...
            initNewActivityTab: function() {
                ...
                self.addNewButtonEnable = ko.computed( function() {
                    return (ko.unwrap( self.selectedPatientId ) && ko.unwrap( self.selectedFolder ) && ko.unwrap( self.selectedFolder )._id && ko.unwrap( self.selectedActivityType ));
                } );
        ...
        PatientAndActivitySelectModal.prototype.showDialog = function( data, callback ) {
            ...
            function show() {
                Promise.resolve( Y.doccirrus.jsonrpc.api.jade
                    .renderFile( {path: 'DeviceLogMojit/views/patientAndActivitySelectDialog'} )
                )
                    .then( function( response ) {
                    ...
                    .then( function( template ) {
                        ...
                        function addAsNew() {
                            var actType = ko.unwrap( patAndActSelModel.selectedActivityType ),
                                caseFolderId = ko.unwrap( patAndActSelModel.selectedCaseFolder )._id;
                            if (actType && caseFolderId) {
                                Y.doccirrus.jsonrpc.api.devicelog.claimDeviceLogEntry( {
                                    data: {
                                        createNew: true,
                                        patientId: ko.unwrap( patAndActSelModel.selectedPatientId ),
        ...
        Y.namespace( 'doccirrus.modals' ).patientAndActivitySelect = new PatientAndActivitySelectModal();
