...
YUI.add( 'PatientGadgetLastNoShowAppointments', function( Y/*, NAME*/ ) {
    'use strict';
    /**
     * @module PatientGadgetLastNoShowAppointments
     */
    var
        unwrap = ko.unwrap,
        ...
        CONFIG_FIELDS = GADGET_LAYOUT_PATIENT.configFields.configurableTable.PatientGadgetLastNoShowAppointments,

        I18N_CALENDAR_NOT_FOUND = i18n( 'PatientGadget.PatientGadgetLastNoShowAppointments.calendarNotFound' );

    /**
     * @constructor
     * @class PatientGadgetLastNoShowAppointments
     * @extends PatientGadgetConfigurableTableBase
     */
    function PatientGadgetLastNoShowAppointments() {
        PatientGadgetLastNoShowAppointments.superclass.constructor.apply( this, arguments );
    }

    Y.extend( PatientGadgetLastNoShowAppointments, PatientGadgetConfigurableTableBase, {
        /** @private */
        initializer: function() {
            ...
            self.initPatientGadgetLastNoShowAppointments();
        },
        /** @private */
        destructor: function() {
            var
        ...
        appointments: null,
        initPatientGadgetLastNoShowAppointments: function() {
            var
                self = this;

            self.lastNoShowAppointmentsI18n = i18n( 'PatientGadget.PatientGadgetLastNoShowAppointments.i18n' );
        ...
        NAME: 'PatientGadgetLastNoShowAppointments',
        ATTRS: {
            availableConfigurableTableColumns: {
                value: [
                    {
                        val: CONFIG_FIELDS.START,
                        i18n: i18n( 'PatientGadget.PatientGadgetLastNoShowAppointments.CONFIG_FIELDS.START' ),
                    ...
                    },
                    {
                        ...
                        i18n: i18n( 'PatientGadget.PatientGadgetLastNoShowAppointments.CONFIG_FIELDS.SCHEDULE_TITLE' ),
                        converter: function( value, data ) {
                    ...
                    },
                    {
                        ...
                        i18n: i18n( 'PatientGadget.PatientGadgetLastNoShowAppointments.CONFIG_FIELDS.CALENDAR_NAME' ),
                    ...
                    },
                    {
                        ...
                        i18n: i18n( 'PatientGadget.PatientGadgetLastNoShowAppointments.CONFIG_FIELDS.EMPLOYEE_NAME' ),
                        converter: function( value/*, data*/ ) {
                            var
                                employee = value,
                                result = '';
    ...
    KoViewModel.registerConstructor( PatientGadgetLastNoShowAppointments );
