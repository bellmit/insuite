...
YUI.add( 'PatientGadgetUpcomingAppointments', function( Y/*, NAME*/ ) {
    'use strict';
    /**
     * @module PatientGadgetUpcomingAppointments
     */
    var
        unwrap = ko.unwrap,
        ...
        CONFIG_FIELDS = GADGET_LAYOUT_PATIENT.configFields.configurableTable.PatientGadgetUpcomingAppointments,

        I18N_CALENDAR_NOT_FOUND = i18n( 'PatientGadget.PatientGadgetUpcomingAppointments.calendarNotFound' );

    /**
     * @constructor
     * @class PatientGadgetUpcomingAppointments
     * @extends PatientGadgetConfigurableTableBase
     */
    function PatientGadgetUpcomingAppointments() {
        PatientGadgetUpcomingAppointments.superclass.constructor.apply( this, arguments );
    }

    Y.extend( PatientGadgetUpcomingAppointments, PatientGadgetConfigurableTableBase, {
        /** @private */
        initializer: function() {
            ...
            self.initPatientGadgetUpcomingAppointments();
        },
        /** @private */
        destructor: function() {
            var
        ...
        appointments: null,
        initPatientGadgetUpcomingAppointments: function() {
            var
                self = this,
                binder = self.get( 'binder' ),
                currentPatient = binder && peek( binder.currentPatient );

            self.upcomingAppointmentsI18n = i18n( 'PatientGadget.PatientGadgetUpcomingAppointments.i18n' );
        ...
        NAME: 'PatientGadgetUpcomingAppointments',
        ATTRS: {
            availableConfigurableTableColumns: {
                value: [
                    {
                        val: CONFIG_FIELDS.START,
                        i18n: i18n( 'PatientGadget.PatientGadgetUpcomingAppointments.CONFIG_FIELDS.START' ),
                    ...
                    },
                    {
                        ...
                        i18n: i18n( 'PatientGadget.PatientGadgetUpcomingAppointments.CONFIG_FIELDS.SCHEDULE_TITLE' ),
                        converter: function( value, data ) {
                    ...
                    },
                    {
                        ...
                        i18n: i18n( 'PatientGadget.PatientGadgetUpcomingAppointments.CONFIG_FIELDS.CALENDAR_NAME' ),
                    ...
                    },
                    {
                        ...
                        i18n: i18n( 'PatientGadget.PatientGadgetUpcomingAppointments.CONFIG_FIELDS.EMPLOYEE_NAME' ),
                        converter: function( value/*, data*/ ) {
                            var
                                employee = value,
                                result = '';
                    ...
                    },
                    {
                        ...
                        i18n: i18n( 'PatientGadget.PatientGadgetUpcomingAppointments.CONFIG_FIELDS.DETAILS' ),
                        converter: function( value/*, data*/ ) {
                            return value || '';
                        }
                    }
    ...
    KoViewModel.registerConstructor( PatientGadgetUpcomingAppointments );
