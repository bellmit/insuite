...
/*global YUI, ko */
YUI.add(
    'MISMojitBinderDirectives',
    function( Y, NAME ) {
        'use strict';

        /**
         * Constructor for the MISMojitBinderDirectives class.
         *
         * @class MISMojitBinderDirectives
         * @constructor
         */
        Y.namespace( 'mojito.binders' )[NAME] = {
             ...
             */
            bind: function( /*node*/ ) {
                Y.doccirrus.NavBarHeader.setActiveEntry( 'directives' );
