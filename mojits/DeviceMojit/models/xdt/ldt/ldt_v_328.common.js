...
YUI.add( 'ldt_v_328', function( Y ) {
        ...
        ldt328.type = "ldt";
        ldt328.name = "ldt328";
        ldt328.version = "LDT3.2.8";
        ldt328.versionField = "0001";
        ldt328.acceptedVersions = ["LDT3.2.8"];

        ldt328.dateFormat = "YYYYMMDD";
        ldt328.shortDateFormat = "YYMM";
        ldt328.timeFormat = "HHmmssSSS";

        ldt328.fileNameFormat = /^Z01.+\.ldt$/;

        ldt328.sizeCounter = 1; //1 byte for the counter
        ldt328.sizeLabel = 3; //3 bytes for the Label: B00/B01/B02
        ldt328.sizeDataField = 60; //128 bytes for field content
        ldt328.sizeCrc16 = 4;
        ldt328.sizeLen = 3;
        ldt328.sizeRecLen = 5;
        ldt328.sizefileLen = 8;
        ldt328.sizeSatz = 4;
        ldt328.sizeFk = 4;

        ldt328.encodings = ["ISO 8859-15"];
        ldt328.encodingField = "9106";

        ldt328.serialCr = "[CR]"; //0x0D
        ldt328.serialNewLineReplacement = "[FS]"; //0x1C

        ldt328.recordType = "8000";
        ldt328.recordEnd = "8001";
        // ldt328.recordSize = "8100";
        ldt328.objType = "8002";
        ldt328.objEnd = "8003"; //no length content
        // ldt328.objEntries = "8003";
        // ldt328.recordLength = "9202";

        ldt328.objectStyle = "ldt30";
        ...
        ldt328.fields = {
            ...
            "3312": {  desc: "Freitext",                                                                attribute: "freeFormText",                      type: "string", len: "<=120"},
            ...
            "3315": {  desc: "Jahr des Tests",                                                          attribute: "yearOfTest",                        type: "number", len: "4"},
            "3316": {  desc: "HPV-HR-Testergebnis",                                                     attribute: "hpvHrTestResult",                   type: "number", len: "1", mapper: "hpvHrTestResult"},
            "3317": {  desc: "HPV-Typ 16/18",                                                           attribute: "hpvType",                           type: "number", len: "1"},
            ...
            "7389": {  desc: "Bisher unbekannte Behandlungsbedürftige Nebenbefunde",                    attribute: "secFindingsRequiringTreatment",     type: "number",len: "1",    mapper: "noYes"},
        ...
        ldt328.stringMappers = {
            ...
            satzID: function( prop/*, propInfo*/ ) {
                //return [propInfo && propInfo.desc, ldt328.saetze[prop].desc];
                return [' - ' + ldt328.saetze[prop.head].desc + ' - ', undefined, true];
            },
            ...
            coronaReasonOfTest: basicMapper( {
                ...
                4: '§ 4 Nr. 1-3 RVO Verhütung der Verbreitung',
                5: '§ 4 Nr. 4 b) RVO Risikogebiet (Inland)',
                6: '§ 4 Nr. 4 a) RVO Auslandsaufenthalt'
            } ),
            ...
            coronaCommissioning: basicMapper( {
                1: 'Testung nach Meldung „erhöhtes Risiko“ durch Corona-Warn-App',
        ...
        Y.namespace( 'doccirrus.api.xdtVersions.ldt' ).ldt328 = ldt328;
