...
YUI.add( 'ldt_v_325', function( Y ) {
        ...
        ldt325.type = "ldt";
        ldt325.name = "ldt325";
        ldt325.version = "LDT3.2.5";
        ldt325.versionField = "0001";
        ldt325.acceptedVersions = ["LDT3.2.5"];

        ldt325.dateFormat = "YYYYMMDD";
        ldt325.shortDateFormat = "YYMM";
        ldt325.timeFormat = "HHmmssSSS";

        ldt325.fileNameFormat = /^Z01.+\.ldt$/;

        ldt325.sizeCounter = 1; //1 byte for the counter
        ldt325.sizeLabel = 3; //3 bytes for the Label: B00/B01/B02
        ldt325.sizeDataField = 60; //128 bytes for field content
        ldt325.sizeCrc16 = 4;
        ldt325.sizeLen = 3;
        ldt325.sizeRecLen = 5;
        ldt325.sizefileLen = 8;
        ldt325.sizeSatz = 4;
        ldt325.sizeFk = 4;

        ldt325.encodings = ["ISO 8859-15"];
        ldt325.encodingField = "9106";

        ldt325.serialCr = "[CR]"; //0x0D
        ldt325.serialNewLineReplacement = "[FS]"; //0x1C

        ldt325.recordType = "8000";
        ldt325.recordEnd = "8001";
        // ldt325.recordSize = "8100";
        ldt325.objType = "8002";
        ldt325.objEnd = "8003"; //no length content
        // ldt325.objEntries = "8003";
        // ldt325.recordLength = "9202";

        ldt325.objectStyle = "ldt30";
        ...
        ldt325.stringMappers = {
            ...
            satzID: function( prop/*, propInfo*/ ) {
                //return [propInfo && propInfo.desc, ldt325.saetze[prop].desc];
                return [' - '+ldt325.saetze[prop.head].desc+' - ', undefined, true];
            },
        ...
        Y.namespace( 'doccirrus.api.xdtVersions.ldt' ).ldt325 = ldt325;
