...
YUI.add( 'ldt_v_312', function( Y ) {
        ...
        ldt312.type = "ldt";
        ldt312.name = "ldt312";
        ldt312.version = "LDT3.1.2";
        ldt312.versionField = "0001";
        ldt312.acceptedVersions = ["LDT3.1.2"];

        ldt312.dateFormat = "YYYYMMDD";
        ldt312.shortDateFormat = "YYMM";
        ldt312.timeFormat = "HHmmssSSS";

        ldt312.fileNameFormat = /^Z01.+\.ldt$/;

        ldt312.sizeCounter = 1; //1 byte for the counter
        ldt312.sizeLabel = 3; //3 bytes for the Label: B00/B01/B02
        ldt312.sizeDataField = 60; //128 bytes for field content
        ldt312.sizeCrc16 = 4;
        ldt312.sizeLen = 3;
        ldt312.sizeRecLen = 5;
        ldt312.sizefileLen = 8;
        ldt312.sizeSatz = 4;
        ldt312.sizeFk = 4;

        ldt312.encodings = ["ASCII (german)", "Code page 437", "ISO 8859-1", "ISO 8859-15"];
        ldt312.encodingField = "9106";

        ldt312.serialCr = "[CR]"; //0x0D
        ldt312.serialNewLineReplacement = "[FS]"; //0x1C

        ldt312.recordType = "8000";
        ldt312.recordEnd = "8001";
        // ldt312.recordSize = "8100";
        ldt312.objType = "8002";
        ldt312.objEnd = "8003"; //no length content
        // ldt312.objEntries = "8003";
        // ldt312.recordLength = "9202";

        ldt312.objectStyle = "ldt30";
        ...
        ldt312.fields = {
            ...
            "8219": {  desc: "Timestamp Materialabnahme entnahme",                                      attribute: "obj_0054Attribute7",                type: "string",len: "33",   mapper: "objTypeHeader"},
        ...
        ldt312.stringMappers = {
            ...
            satzID: function( prop/*, propInfo*/ ) {
                //return [propInfo && propInfo.desc, ldt312.saetze[prop].desc];
                return [' - '+ldt312.saetze[prop.head].desc+' - ', undefined, true];
            },
        ...
        Y.namespace( 'doccirrus.api.xdtVersions.ldt' ).ldt312 = ldt312;
