...
YUI.add( 'ldt_v_313', function( Y ) {
        ...
        ldt313.type = "ldt";
        ldt313.name = "ldt313";
        ldt313.version = "LDT3.1.3";
        ldt313.versionField = "0001";
        ldt313.acceptedVersions = ["LDT3.1.3"];

        ldt313.dateFormat = "YYYYMMDD";
        ldt313.shortDateFormat = "YYMM";
        ldt313.timeFormat = "HHmmssSSS";

        ldt313.fileNameFormat = /^Z01.+\.ldt$/;

        ldt313.sizeCounter = 1; //1 byte for the counter
        ldt313.sizeLabel = 3; //3 bytes for the Label: B00/B01/B02
        ldt313.sizeDataField = 60; //128 bytes for field content
        ldt313.sizeCrc16 = 4;
        ldt313.sizeLen = 3;
        ldt313.sizeRecLen = 5;
        ldt313.sizefileLen = 8;
        ldt313.sizeSatz = 4;
        ldt313.sizeFk = 4;

        ldt313.encodings = ["ASCII (german)", "Code page 437", "ISO 8859-1", "ISO 8859-15"];
        ldt313.encodingField = "9106";

        ldt313.serialCr = "[CR]"; //0x0D
        ldt313.serialNewLineReplacement = "[FS]"; //0x1C

        ldt313.recordType = "8000";
        ldt313.recordEnd = "8001";
        // ldt313.recordSize = "8100";
        ldt313.objType = "8002";
        ldt313.objEnd = "8003"; //no length content
        // ldt313.objEntries = "8003";
        // ldt313.recordLength = "9202";

        ldt313.objectStyle = "ldt30";
        ...
        ldt313.stringMappers = {
            ...
            satzID: function( prop/*, propInfo*/ ) {
                //return [propInfo && propInfo.desc, ldt313.saetze[prop].desc];
                return [' - '+ldt313.saetze[prop.head].desc+' - ', undefined, true];
            },
        ...
        Y.namespace( 'doccirrus.api.xdtVersions.ldt' ).ldt313 = ldt313;
