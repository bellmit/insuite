...
YUI.add( 'ldt_v_321', function( Y ) {
        ...
        ldt321.type = "ldt";
        ldt321.name = "ldt321";
        ldt321.version = "LDT3.2.1";
        ldt321.versionField = "0001";
        ldt321.acceptedVersions = ["LDT3.2.1"];

        ldt321.dateFormat = "YYYYMMDD";
        ldt321.shortDateFormat = "YYMM";
        ldt321.timeFormat = "HHmmssSSS";

        ldt321.fileNameFormat = /^Z01.+\.ldt$/;

        ldt321.sizeCounter = 1; //1 byte for the counter
        ldt321.sizeLabel = 3; //3 bytes for the Label: B00/B01/B02
        ldt321.sizeDataField = 60; //128 bytes for field content
        ldt321.sizeCrc16 = 4;
        ldt321.sizeLen = 3;
        ldt321.sizeRecLen = 5;
        ldt321.sizefileLen = 8;
        ldt321.sizeSatz = 4;
        ldt321.sizeFk = 4;

        ldt321.encodings = ["ISO 8859-15"];
        ldt321.encodingField = "9106";

        ldt321.serialCr = "[CR]"; //0x0D
        ldt321.serialNewLineReplacement = "[FS]"; //0x1C

        ldt321.recordType = "8000";
        ldt321.recordEnd = "8001";
        // ldt321.recordSize = "8100";
        ldt321.objType = "8002";
        ldt321.objEnd = "8003"; //no length content
        // ldt321.objEntries = "8003";
        // ldt321.recordLength = "9202";

        ldt321.objectStyle = "ldt30";
        ...
        ldt321.stringMappers = {
            ...
            satzID: function( prop/*, propInfo*/ ) {
                //return [propInfo && propInfo.desc, ldt321.saetze[prop].desc];
                return [' - '+ldt321.saetze[prop.head].desc+' - ', undefined, true];
            },
        ...
        Y.namespace( 'doccirrus.api.xdtVersions.ldt' ).ldt321 = ldt321;
