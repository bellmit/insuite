...
YUI.add( 'ldt_v_327', function( Y ) {
        ...
        ldt327.type = "ldt";
        ldt327.name = "ldt327";
        ldt327.version = "LDT3.2.7";
        ldt327.versionField = "0001";
        ldt327.acceptedVersions = ["LDT3.2.7"];

        ldt327.dateFormat = "YYYYMMDD";
        ldt327.shortDateFormat = "YYMM";
        ldt327.timeFormat = "HHmmssSSS";

        ldt327.fileNameFormat = /^Z01.+\.ldt$/;

        ldt327.sizeCounter = 1; //1 byte for the counter
        ldt327.sizeLabel = 3; //3 bytes for the Label: B00/B01/B02
        ldt327.sizeDataField = 60; //128 bytes for field content
        ldt327.sizeCrc16 = 4;
        ldt327.sizeLen = 3;
        ldt327.sizeRecLen = 5;
        ldt327.sizefileLen = 8;
        ldt327.sizeSatz = 4;
        ldt327.sizeFk = 4;

        ldt327.encodings = ["ISO 8859-15"];
        ldt327.encodingField = "9106";

        ldt327.serialCr = "[CR]"; //0x0D
        ldt327.serialNewLineReplacement = "[FS]"; //0x1C

        ldt327.recordType = "8000";
        ldt327.recordEnd = "8001";
        // ldt327.recordSize = "8100";
        ldt327.objType = "8002";
        ldt327.objEnd = "8003"; //no length content
        // ldt327.objEntries = "8003";
        // ldt327.recordLength = "9202";

        ldt327.objectStyle = "ldt30";
        ...
        ldt327.stringMappers = {
            ...
            satzID: function( prop/*, propInfo*/ ) {
                //return [propInfo && propInfo.desc, ldt327.saetze[prop].desc];
                return [' - ' + ldt327.saetze[prop.head].desc + ' - ', undefined, true];
            },
        ...
        Y.namespace( 'doccirrus.api.xdtVersions.ldt' ).ldt327 = ldt327;
