...
YUI.add( 'ldt_v_322', function( Y ) {
        ...
        ldt322.type = "ldt";
        ldt322.name = "ldt322";
        ldt322.version = "LDT3.2.2";
        ldt322.versionField = "0001";
        ldt322.acceptedVersions = ["LDT3.2.2"];

        ldt322.dateFormat = "YYYYMMDD";
        ldt322.shortDateFormat = "YYMM";
        ldt322.timeFormat = "HHmmssSSS";

        ldt322.fileNameFormat = /^Z01.+\.ldt$/;

        ldt322.sizeCounter = 1; //1 byte for the counter
        ldt322.sizeLabel = 3; //3 bytes for the Label: B00/B01/B02
        ldt322.sizeDataField = 60; //128 bytes for field content
        ldt322.sizeCrc16 = 4;
        ldt322.sizeLen = 3;
        ldt322.sizeRecLen = 5;
        ldt322.sizefileLen = 8;
        ldt322.sizeSatz = 4;
        ldt322.sizeFk = 4;

        ldt322.encodings = ["ISO 8859-15"];
        ldt322.encodingField = "9106";

        ldt322.serialCr = "[CR]"; //0x0D
        ldt322.serialNewLineReplacement = "[FS]"; //0x1C

        ldt322.recordType = "8000";
        ldt322.recordEnd = "8001";
        // ldt322.recordSize = "8100";
        ldt322.objType = "8002";
        ldt322.objEnd = "8003"; //no length content
        // ldt322.objEntries = "8003";
        // ldt322.recordLength = "9202";

        ldt322.objectStyle = "ldt30";
        ...
        ldt322.stringMappers = {
            ...
            satzID: function( prop/*, propInfo*/ ) {
                //return [propInfo && propInfo.desc, ldt322.saetze[prop].desc];
                return [' - '+ldt322.saetze[prop.head].desc+' - ', undefined, true];
            },
        ...
        Y.namespace( 'doccirrus.api.xdtVersions.ldt' ).ldt322 = ldt322;
