...
YUI.add( 'ldt_v_310', function( Y ) {
        ...
        ldt310.type = "ldt";
        ldt310.name = "ldt30";
        ldt310.version = "LDT3.1.0";
        ldt310.versionField = "0001";
        ldt310.acceptedVersions = ["LDT3.1.0"];

        ldt310.dateFormat = "YYYYMMDD";
        ldt310.shortDateFormat = "YYMM";
        ldt310.timeFormat = "HHmmssSSS";

        ldt310.fileNameFormat = /^Z01.+\.ldt$/;

        ldt310.sizeCounter = 1; //1 byte for the counter
        ldt310.sizeLabel = 3; //3 bytes for the Label: B00/B01/B02
        ldt310.sizeDataField = 60; //128 bytes for field content
        ldt310.sizeCrc16 = 4;
        ldt310.sizeLen = 3;
        ldt310.sizeRecLen = 5;
        ldt310.sizefileLen = 8;
        ldt310.sizeSatz = 4;
        ldt310.sizeFk = 4;

        ldt310.encodings = ["ISO 8859-15"];
        ldt310.encodingField = "9106";

        ldt310.serialCr = "[CR]"; //0x0D
        ldt310.serialNewLineReplacement = "[FS]"; //0x1C

        ldt310.recordType = "8000";
        ldt310.recordEnd = "8001";
        // ldt310.recordSize = "8100";
        ldt310.objType = "8002";
        ldt310.objEnd = "8003"; //no length content
        // ldt310.objEntries = "8003";
        // ldt310.recordLength = "9202";

        ldt310.objectStyle = "ldt30";
        ...
        ldt310.stringMappers = {
            ...
            satzID: function( prop/*, propInfo*/ ) {
                //return [propInfo && propInfo.desc, ldt310.saetze[prop].desc];
                return [' - '+ldt310.saetze[prop.head].desc+' - ', undefined, true];
            },
        ...
        Y.namespace( 'doccirrus.api.xdtVersions.ldt' ).ldt310 = ldt310;
