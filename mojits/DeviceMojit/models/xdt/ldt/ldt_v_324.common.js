...
YUI.add( 'ldt_v_324', function( Y ) {
        ...
        ldt324.type = "ldt";
        ldt324.name = "ldt324";
        ldt324.version = "LDT3.2.4";
        ldt324.versionField = "0001";
        ldt324.acceptedVersions = ["LDT3.2.4"];

        ldt324.dateFormat = "YYYYMMDD";
        ldt324.shortDateFormat = "YYMM";
        ldt324.timeFormat = "HHmmssSSS";

        ldt324.fileNameFormat = /^Z01.+\.ldt$/;

        ldt324.sizeCounter = 1; //1 byte for the counter
        ldt324.sizeLabel = 3; //3 bytes for the Label: B00/B01/B02
        ldt324.sizeDataField = 60; //128 bytes for field content
        ldt324.sizeCrc16 = 4;
        ldt324.sizeLen = 3;
        ldt324.sizeRecLen = 5;
        ldt324.sizefileLen = 8;
        ldt324.sizeSatz = 4;
        ldt324.sizeFk = 4;

        ldt324.encodings = ["ISO 8859-15"];
        ldt324.encodingField = "9106";

        ldt324.serialCr = "[CR]"; //0x0D
        ldt324.serialNewLineReplacement = "[FS]"; //0x1C

        ldt324.recordType = "8000";
        ldt324.recordEnd = "8001";
        // ldt324.recordSize = "8100";
        ldt324.objType = "8002";
        ldt324.objEnd = "8003"; //no length content
        // ldt324.objEntries = "8003";
        // ldt324.recordLength = "9202";

        ldt324.objectStyle = "ldt30";
        ...
        ldt324.stringMappers = {
            ...
            satzID: function( prop/*, propInfo*/ ) {
                //return [propInfo && propInfo.desc, ldt324.saetze[prop].desc];
                return [' - '+ldt324.saetze[prop.head].desc+' - ', undefined, true];
            },
        ...
        Y.namespace( 'doccirrus.api.xdtVersions.ldt' ).ldt324 = ldt324;
