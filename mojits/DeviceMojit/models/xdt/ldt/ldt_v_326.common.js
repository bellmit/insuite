...
YUI.add( 'ldt_v_326', function( Y ) {
        ...
        ldt326.type = "ldt";
        ldt326.name = "ldt326";
        ldt326.version = "LDT3.2.6";
        ldt326.versionField = "0001";
        ldt326.acceptedVersions = ["LDT3.2.6"];

        ldt326.dateFormat = "YYYYMMDD";
        ldt326.shortDateFormat = "YYMM";
        ldt326.timeFormat = "HHmmssSSS";

        ldt326.fileNameFormat = /^Z01.+\.ldt$/;

        ldt326.sizeCounter = 1; //1 byte for the counter
        ldt326.sizeLabel = 3; //3 bytes for the Label: B00/B01/B02
        ldt326.sizeDataField = 60; //128 bytes for field content
        ldt326.sizeCrc16 = 4;
        ldt326.sizeLen = 3;
        ldt326.sizeRecLen = 5;
        ldt326.sizefileLen = 8;
        ldt326.sizeSatz = 4;
        ldt326.sizeFk = 4;

        ldt326.encodings = ["ISO 8859-15"];
        ldt326.encodingField = "9106";

        ldt326.serialCr = "[CR]"; //0x0D
        ldt326.serialNewLineReplacement = "[FS]"; //0x1C

        ldt326.recordType = "8000";
        ldt326.recordEnd = "8001";
        // ldt326.recordSize = "8100";
        ldt326.objType = "8002";
        ldt326.objEnd = "8003"; //no length content
        // ldt326.objEntries = "8003";
        // ldt326.recordLength = "9202";

        ldt326.objectStyle = "ldt30";
        ...
        ldt326.objects = {
            ...
            "Obj_0009": {
                desc: "Abrechnung OEGD", fk: {
                    "fk4110": {amount: "1", optional: true},
                    "fk8616": {amount: "1", optional: true},
                    "fk8617": {amount: "1", optional: false},
                    "fk8618": {amount: "1", optional: true},
                    "fk8619": {amount: "1", optional: true},
                    "fk8620": {amount: "n", optional: true},
                    "fk8621": {amount: "1", optional: true},
            ...
            "Obj_0017": {
                desc: "Befundinformationen", fk: {
                    ...
                    "fk8622": {amount: "1", optional: false},
                    "fk8311": {
                        amount: "1", optional: false, children: {
        ...
        ldt326.stringMappers = {
            ...
            satzID: function( prop/*, propInfo*/ ) {
                //return [propInfo && propInfo.desc, ldt326.saetze[prop].desc];
                return [' - '+ldt326.saetze[prop.head].desc+' - ', undefined, true];
            },
            ...
            coronaReasonOfTest: basicMapper( {
                ...
                2: '§ 2 Meldung „erhöhtes Risiko“ durch Corona-Warn-App',
        ...
        Y.namespace( 'doccirrus.api.xdtVersions.ldt' ).ldt326 = ldt326;
