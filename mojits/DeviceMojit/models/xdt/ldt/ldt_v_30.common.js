...
YUI.add( 'ldt_v_30', function( Y ) {
        ...
        ldt30.type = "ldt";
        ldt30.name = "ldt30";
        ldt30.version = "LDT3.0.7";
        ldt30.versionField = "0001";
        ldt30.acceptedVersions = ["LDT3.0.7"];

        ldt30.dateFormat = "YYYYMMDD";
        ldt30.shortDateFormat = "YYMM";
        ldt30.timeFormat = "HHmmssSSS";

        ldt30.fileNameFormat = /^Z01.+\.ldt$/;

        ldt30.sizeCounter = 1; //1 byte for the counter
        ldt30.sizeLabel = 3; //3 bytes for the Label: B00/B01/B02
        ldt30.sizeDataField = 60; //128 bytes for field content
        ldt30.sizeCrc16 = 4;
        ldt30.sizeLen = 3;
        ldt30.sizeRecLen = 5;
        ldt30.sizefileLen = 8;
        ...
        ldt30.encodings = ["ISO 8859-15"];
        ldt30.encodingField = "9106";

        ldt30.serialCr = "[CR]"; //0x0D
        ldt30.serialNewLineReplacement = "[FS]"; //0x1C

        ldt30.recordType = "8000";
        ldt30.recordEnd = "8001";
        // ldt30.recordSize = "8100";
        ldt30.objType = "8002";
        ldt30.objEnd = "8003"; //no length content
        // ldt30.objEntries = "8003";
        // ldt30.recordLength = "9202";

        ldt30.objectStyle = "ldt30";
        ...
        ldt30.fields = {
            ...
            "3564": {  desc: "Text",                                                                  attribute: "text",                           type: "string", len: "<=60"  },
            "3620": {  desc: "Beruf der Person",                                                      attribute: "personJob",                      type: "string", len: "<=60"  },
            "3621": {  desc: "Aktuelle berufliche Tätigkeit",                                         attribute: "personCurrentJob",               type: "string", len: "<=60"  },
            ...
            "4106": {  desc: "Kostenträger-Abrechnungsbereich (KTAB)",                                attribute: "payerBillingArea",               type: "number", len: "2", mapper: "ktab"  },
            ...
            "4131": {  desc: "Besondere Personengruppen",                                             attribute: "insuranceSpeGroup",              type: "string", len: "<=2", mapper: "specialGroup"  },
            "4132": {  desc: "DMP_Kennzeichnung",                                                     attribute: "insuranceDmp",                   type: "string", len: "<=2", mapper: "dmp"  },
            ...
            "6207": {  desc: "Rezeptur",                                                              attribute: "medicationRecipe",               type: "string", len: "<=60"  },
            ...
            "7253": {  desc: "Kostenübernahmeerklärung des Auftraggebers liegt vor",                  attribute: "commissionerCostCovStatement",   type: "number", len: "1", mapper: "neinJa"  },
            ...
            "7262": {  desc: "Status der Dringlichkeit",                                              attribute: "urgencyStatus",                  type: "number", len: "1", mapper: "E045"  },
            ...
            "7272": {  desc: "Freitext zum Timestamp",                                                attribute: "timestampFreeText",              type: "string", len: "<=60"  },
            ...
            "7290": {  desc: "Resistenz-Interpretation",                                              attribute: "resistanceInterpretation",       type: "number", len: "1", mapper: "resistenzInterpretation"  },
            ...
            "7296": {  desc: "Wiederholungsuntersuchung",                                             attribute: "examRepeated",                   type: "string", len: "1", mapper: "neinJa"  },
            ...
            "7301": {  desc: "Ergebnisstatus",                                                        attribute: "resultStatus",                   type: "number", len: "1", mapper: "resultStatus"  },
            ...
            "7310": {  desc: "Art des Materials",                                                     attribute: "materialKind",                   type: "number", len: "1", mapper: "artDesMaterials"  },
            "7311": {  desc: "Organisches Material",                                                  attribute: "materialIsOrganic",              type: "number", len: "1", mapper: "organischesMaterial"  },
            "7312": {  desc: "Anorganisches Material",                                                attribute: "materialIsAnorganic",            type: "number", len: "1", mapper: "anorganischesMaterial"  },
            ...
            "7321": {  desc: "Status Einsender",                                                      attribute: "senderStatus",                   type: "number", len: "2", mapper: "statusEinsender"  },
            ...
            "7336": {  desc: "Gyn. OP, Strahlen oder Chemotherapie",                                  attribute: "gynsurgRadChemo",                type: "number", len: "1", mapper: "neinJa"  },
            ...
            "7339": {  desc: "Gravidität",                                                            attribute: "gravidity",                      type: "number", len: "1", mapper: "neinJa"  },
            ...
            "7354": {  desc: "Keim-Identifizierung",                                                  attribute: "germId",                         type: "string", len: "<=60"  },
            "7355": {  desc: "Keim-Name",                                                             attribute: "germName",                       type: "string", len: "<=60"  },
            "7356": {  desc: "Keim-OID",                                                              attribute: "germOID",                        type: "string", len: "<=60"  },
            "7357": {  desc: "Wachstum",                                                              attribute: "growth",                         type: "number", len: "1", mapper: "wachstum"  },
            ...
            "7367": {  desc: "Sensitivität",                                                          attribute: "sensitivity",                    type: "string", len: "1", mapper: "sensitivitaet"  },
            ...
            "7380": {  desc: "Path. gynäkologische Blutungen",                                        attribute: "pathGynBleeds",                  type: "number", len: "1", mapper: "neinJa"  },
            "7381": {  desc: "Sonstiger Ausfluss",                                                    attribute: "otherDischarge",                 type: "number", len: "1", mapper: "neinJa"  },
            "7382": {  desc: "IUP",                                                                   attribute: "iup",                            type: "number", len: "1", mapper: "neinJa"  },
            "7383": {  desc: "Ovulationshemmer",                                                      attribute: "ovulationInhibitor",             type: "number", len: "1", mapper: "neinJa"  },
            "7384": {  desc: "Sonstige Hormonanwendung",                                              attribute: "otherHormoneTreatment",          type: "number", len: "1", mapper: "neinJa"  },
            "7385": {  desc: "Vulva Inspektion auffällig",                                            attribute: "vulvaInspectionSuspicious",      type: "number", len: "1", mapper: "neinJa"  },
            "7386": {  desc: "Portio und Vagina auffällig",                                           attribute: "portioAndVaginaSuspicious",      type: "number", len: "1", mapper: "neinJa"  },
            "7387": {  desc: "Inneres Genitale auffällig",                                            attribute: "innerGenitalsSuspicious",        type: "number", len: "1", mapper: "neinJa"  },
            "7388": {  desc: "Inguinale Lymphknoten auffällig",                                       attribute: "inguinalLymphNodesSuspicious",   type: "number", len: "1", mapper: "neinJa"  },
            "7389": {  desc: "Behandlungsbedürftige Nebenbefunde",                                    attribute: "secFindingsRequiringTreatment",  type: "number", len: "1", mapper: "neinJa"  },
            "7390": {  desc: "Haut",                                                                  attribute: "skin",                           type: "number", len: "1", mapper: "neinJa"  },
            "7391": {  desc: "Mamma auffällig",                                                       attribute: "mammaSuspicious",                type: "number", len: "1", mapper: "neinJa"  },
            "7392": {  desc: "Axilläre Lymphknoten auffällig",                                        attribute: "axillaryLymphNodesSuspicious",   type: "number", len: "1", mapper: "neinJa"  },
            "7393": {  desc: "Rektum/Kolon: Blut oder Schleim",                                       attribute: "rectColonBloodOrSlime",          type: "number", len: "1", mapper: "neinJa"  },
            "7394": {  desc: "Neu aufgetr. Unregelmäßigkeiten",                                       attribute: "irregularitiesNew",              type: "number", len: "1", mapper: "neinJa"  },
            "7395": {  desc: "Rektum/Kolon: Tastbefund auffällig",                                    attribute: "rectColonPalpationSuspicious",   type: "number", len: "1", mapper: "neinJa"  },
            "7396": {  desc: "Stuhltest zurückgegeben",                                               attribute: "stoolProbeReturned",             type: "number", len: "1", mapper: "neinJa"  },
            "7397": {  desc: "Stuhltest positiv",                                                     attribute: "stoolProbePositive",             type: "number", len: "1", mapper: "neinJa"  },
            "7398": {  desc: "RR (Blutdruck)",                                                        attribute: "rr",                             type: "string", len: "7"  },
            "7399": {  desc: "RR, zweite Messung",                                                    attribute: "rr2",                            type: "string", len: "7"  },
            "7400": {  desc: "HPV-Befund",                                                            attribute: "hpvFinding",                     type: "number", len: "1", mapper: "neinJa"  },
            ...
            "7407": {  desc: "Döderleinflora",                                                        attribute: "floraDöderlein",                 type: "number", len: "1", mapper: "neinJa"  },
            "7408": {  desc: "Mischflora",                                                            attribute: "floraMixed",                     type: "number", len: "1", mapper: "neinJa"  },
            "7409": {  desc: "Kokkenflora",                                                           attribute: "floraKokken",                    type: "number", len: "1", mapper: "neinJa"  },
            "7410": {  desc: "Trichomonaden",                                                         attribute: "trichomonads",                   type: "number", len: "1", mapper: "neinJa"  },
            "7411": {  desc: "Candida",                                                               attribute: "candida",                        type: "number", len: "1", mapper: "neinJa"  },
            "7412": {  desc: "Gardnerella",                                                           attribute: "gardnerella",                    type: "number", len: "1", mapper: "neinJa"  },
            ...
            "7415": {  desc: "Zytologische Kontrolle",                                                attribute: "cytologicalControl",             type: "number", len: "1", mapper: "neinJa"  },
            "7416": {  desc: "Grund der Nachkontrolle",                                               attribute: "reasonForAddControl",            type: "number", len: "1", mapper: "reasonForAddControl"  },
            "7417": {  desc: "Histologische Klärung",                                                 attribute: "histClarification",              type: "number", len: "1", mapper: "neinJa"  },
            ...
            "7420": {  desc: "Status Person",                                                         attribute: "personStatus",                   type: "number", len: "2", mapper: "statusPerson"  },
            "7421": {  desc: "Status Rechnungsempfänger",                                             attribute: "billingRecipientStatus",         type: "number", len: "2", mapper: "statusRechnungsempfaenger"  },
            "7422": {  desc: "Chlamydien",                                                            attribute: "chlamydia",                      type: "number", len: "1", mapper: "positiveNegativeInvalid"  },
            "7423": {  desc: "Gyn. Diagnose",                                                         attribute: "gynDiagnosis",                   type: "string", len: "<=60"  },
            ...
            "8410": {  desc: "Test-ID",                                                               attribute: "testId",                         type: "string", len: "<=60"  },
            ...
            "8419": {  desc: "Einheit des Messwertes / Wertes in",                                    attribute: "measurementUnitKind",            type: "number", len: "1", mapper: "measurementUnitKind"  },
            "8420": {  desc: "Ergebnis-Wert",                                                         attribute: "testResultVal",                  type: "string", len: "<=60"  },
            "8421": {  desc: "Einheit des Messwertes / Wertes",                                       attribute: "TestResultUnit",                 type: "string", len: "<=60"  },
            "8422": {  desc: "Grenzwertindikator des Laborwerts",                                     attribute: "testResultLimitIndicator",       type: "string", len: "<=2", mapper: "grenzwertIndikator"  },
            ...
            "8504": {  desc: "Medikamenteneinnahme zum Zeitpunkt der Probenentnahme",                 attribute: "medicationTaken",                type: "number", len: "1", mapper: "neinJa"  },
            ...
            "8614": {  desc: "bereits abgerechnet",                                                   attribute: "billingAlreadyDone",             type: "number", len: "1", mapper: "neinJa"  },
            "8990": {  desc: "Namenskürzel / Namenszeichen",                                          attribute: "nameInitials",                   type: "string", len: "<=60"  },
            "9300": {  desc: "Prüfsumme",                                                             attribute: "checksum",                       type: "string", len: "<=60"  },
        ...
        ldt30.objects = {
                        ...
                        amount: "n", optional: false, children: {
                            ...
                            "fk4208": {
                                amount: "n", optional: false, children: {
                                    "fk6212": {
                                        amount: "n", optional: false, children: {
                                            "fk6214": {amount: "1", optional: false}
                                        }
                                    }
                                }
                            }
            ...
            "Obj_0045": {
                desc: "Patient", fk: {
                    ...
                    "fk3620": {amount: "n", optional: true},
                    "fk3621": {amount: "1", optional: true}
                }
            },
            "Obj_0047": {
                desc: "Person", fk: {
            ...
            "Obj_0062": {
                desc: "Untersuchungsergebnis Zytologie Krebsvorsorge", fk: {
                    ...
                    "fk7417": {amount: "n", optional: false},
                    "fk8237": {
                        amount: "1", optional: true, children: {
                            "Obj_0068": {amount: "1", optional: false}
                        }
                ...
                desc: "Untersuchungsergebnis Zytologie", fk: {
                    ...
                    "fk7400": {
                        amount: "1", optional: false, children: {
                            "fk7401": {
                                amount: "1", optional: false, children: {
                                    "fk7402": {amount: "n", optional: false}
                                }
                            },
                            "fk7403": {
                                amount: "1", optional: false, children: {
                                    "fk7404": {amount: "n", optional: false}
                                }
                            }
                        }
                    },
        ...
        ldt30.stringMappers = {
            ...
            satzID: function( prop/*, propInfo*/ ) {
                //return [propInfo && propInfo.desc, ldt30.saetze[prop].desc];
                return [' - '+ldt30.saetze[prop.head].desc+' - ', undefined, true];
            },
            ...
            grenzwertIndikator: basicMapper( {
                "N": "Normal",
                "H": "schwach erhöht",
                "+": "schwach erhöht",
                "HH": "stark erhöht",
            ...
            ktab: basicMapper( {
                "0": "Primärberechnung",
                "1": "Sozialversicherungsabkommen (SVGA)",
                "2": "Bundesversorgungsgesetz (BVG)",
                "3": "Bundesentschädigungsgesetz (BEG)",
                "4": "Grenzgänger (GG)",
                "5": " Rheinschiffer (RHS)",
                "6": " Sozialhilfeträger, ohne Asylstellen (SHT)",
            ...
            dmp: basicMapper( {
                ...
                "5": "Asthma bronchiale",
                "6": "COPD (chronic obstructive pulmo-nary disease)"
            } ),
            specialGroup: basicMapper( {
                "4": "BSHG (Bundessozialhilfegesetz) § 264 SGB V",
                "6": "BVG (Gesetz über die Versorgung der Opfer des Krieges)",
                "7": "SVA-Kennzeichnung für zwischenstaatliches Krankenversicherunrecht: Personen mit Wohnsitz im Inland, Abrechnung nach Aufwand",
                "8": "SVA-Kennzeichnung, pauschal",
                "9": "Empfänger von Gesundheitsleistungen nach den §§ 4, 6 AsylbLG"
            } ),
            statusEinsender: basicMapperDescLess( {
                "1": "Erstveranlasser",
                "2": "Einsender Arzt",
                "3": "Einsender sonstige",
                "4": "Versicherter",
                "5": "Rechnungsempfänger",
                "6": "Bevollmächtigter",
                "7": "Laborarzt/Befundersteller",
            ...
            sensitivitaet: basicMapper( {
                "S": "sensibel",
                "I": "intermediär",
                "R": "resistent"
            } ),
            wachstum: basicMapper( {
            ...
            statusRechnungsempfaenger: basicMapper( {
                "2": "Einsender Arzt",
                "3": "Einsender sonstige",
                "4": "Versicherter",
                "5": "Rechnungsempfänger",
            ...
            resistenzInterpretation: basicMapper( {
                "0": "nicht getestet",
                "1": "sensibel/wirksam",
            ...
            artDesMaterials: basicMapper( {
                "1": "organisch",
                "2": "anorganisch"
            } ),
            organischesMaterial: basicMapper( {
                "1": "tierisch",
                "2": "pflanzlich",
                "3": "nicht bestimmbar"
            } ),
            anorganischesMaterial: basicMapper( {
                "1": "Wasser",
                "2": "Luft",
                "3": "nicht bestimmbar",
                "4": "sonstiges"
            ...
            resultValues: basicMapper( {
                "1": "numerisch (exponentielle Darstellung möglich)",
                "2": "numerisch mit Messwertuntergrenze",
                "3": "numerisch mit Messwertobergrenze",
                "4": "alpha-numerisch",
                "5": "Titer",
                "6": "Titer mit Untergrenze",
                "7": "Titer mit Obergrenze",
                "99": "Sonstige"
            } ),
        ...
        ldt30.rules = {
            ...
            E051: /^[1-4]$/,
            E052: /^1[0-3]|2[0-8]|30$/,
            E053: /^006|010|10A|039|09[1-4]|10[0-3]|1[1256]0|[2-5]00|25[0-8]|301|999$/,
            E054: /^[1-5]$/,
            E055: /^[0-4]$/,
            E056: /^0|1$/,
            E057: /^[1-4]$/,
            ...
            E064: /^[0-2]$/,
            E065: /^[1-3]$/,
            E066: /^Obj_0(0(0[1-8]|1[013479]|2[267]|3[124-7]|4[0-35]|5[013-689]|6[0-38]|7[01])|100)$/,
            E067: /^[1-3]$/,
            E068: /^[1-4]$/,
            E069: /^[1-7]$/,
            E070: /^[129]$/,
        ...
        Y.namespace( 'doccirrus.api.xdtVersions.ldt' ).ldt30 = ldt30;
