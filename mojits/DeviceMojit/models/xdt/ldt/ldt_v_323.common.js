...
YUI.add( 'ldt_v_323', function( Y ) {
        ...
        ldt323.type = "ldt";
        ldt323.name = "ldt323";
        ldt323.version = "LDT3.2.3";
        ldt323.versionField = "0001";
        ldt323.acceptedVersions = ["LDT3.2.3"];

        ldt323.dateFormat = "YYYYMMDD";
        ldt323.shortDateFormat = "YYMM";
        ldt323.timeFormat = "HHmmssSSS";

        ldt323.fileNameFormat = /^Z01.+\.ldt$/;

        ldt323.sizeCounter = 1; //1 byte for the counter
        ldt323.sizeLabel = 3; //3 bytes for the Label: B00/B01/B02
        ldt323.sizeDataField = 60; //128 bytes for field content
        ldt323.sizeCrc16 = 4;
        ldt323.sizeLen = 3;
        ldt323.sizeRecLen = 5;
        ldt323.sizefileLen = 8;
        ldt323.sizeSatz = 4;
        ldt323.sizeFk = 4;

        ldt323.encodings = ["ISO 8859-15"];
        ldt323.encodingField = "9106";

        ldt323.serialCr = "[CR]"; //0x0D
        ldt323.serialNewLineReplacement = "[FS]"; //0x1C

        ldt323.recordType = "8000";
        ldt323.recordEnd = "8001";
        // ldt323.recordSize = "8100";
        ldt323.objType = "8002";
        ldt323.objEnd = "8003"; //no length content
        // ldt323.objEntries = "8003";
        // ldt323.recordLength = "9202";

        ldt323.objectStyle = "ldt30";
        ...
        ldt323.stringMappers = {
            ...
            satzID: function( prop/*, propInfo*/ ) {
                //return [propInfo && propInfo.desc, ldt323.saetze[prop].desc];
                return [' - '+ldt323.saetze[prop.head].desc+' - ', undefined, true];
            },
        ...
        Y.namespace( 'doccirrus.api.xdtVersions.ldt' ).ldt323 = ldt323;
