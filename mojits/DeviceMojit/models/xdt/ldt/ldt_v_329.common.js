...
YUI.add( 'ldt_v_329', function( Y ) {
        ...
        ldt329.type = "ldt";
        ldt329.name = "ldt329";
        ldt329.version = "LDT3.2.9";
        ldt329.versionField = "0001";
        ldt329.acceptedVersions = ["LDT3.2.9"];

        ldt329.dateFormat = "YYYYMMDD";
        ldt329.shortDateFormat = "YYMM";
        ldt329.timeFormat = "HHmmssSSS";

        ldt329.fileNameFormat = /^Z01.+\.ldt$/;

        ldt329.sizeCounter = 1; //1 byte for the counter
        ldt329.sizeLabel = 3; //3 bytes for the Label: B00/B01/B02
        ldt329.sizeDataField = 60; //128 bytes for field content
        ldt329.sizeCrc16 = 4;
        ldt329.sizeLen = 3;
        ldt329.sizeRecLen = 5;
        ldt329.sizefileLen = 8;
        ldt329.sizeSatz = 4;
        ldt329.sizeFk = 4;

        ldt329.encodings = ["ISO 8859-15"];
        ldt329.encodingField = "9106";

        ldt329.serialCr = "[CR]"; //0x0D
        ldt329.serialNewLineReplacement = "[FS]"; //0x1C

        ldt329.recordType = "8000";
        ldt329.recordEnd = "8001";
        // ldt329.recordSize = "8100";
        ldt329.objType = "8002";
        ldt329.objEnd = "8003"; //no length content
        // ldt329.objEntries = "8003";
        // ldt329.recordLength = "9202";

        ldt329.objectStyle = "ldt30";
        ...
        ldt329.fields = {
            ...
            "3101": {  desc: "Nachname",                                                                attribute: "patientName",                       type: "string", len: "<=45"},
            ...
            "3313": {  desc: "HPV-Impfung",                                                             attribute: "hpvVaccination",                    type: "number", len: "1", mapper: "hpvVaccination"},
            "3314": {  desc: "HPV-HR-Test",                                                             attribute: "hpvHrTest",                         type: "number", len: "1"},
            "3316": {  desc: "HPV-HR-Testergebnis",                                                     attribute: "hpvHrTestResult",                   type: "number", len: "1", mapper: "hpvHrTestResult"},
            "3317": {  desc: "HPV-Typ 16/18",                                                           attribute: "hpvType",                           type: "number", len: "1", mapper: 'hpvType'},
            "3318": {  desc: "HPV-Test",                                                                attribute: "hpvTest",                           type: "number", len: "1"},
            "3319": {  desc: "Ko-Test",                                                                 attribute: "koTest",                            type: "number", len: "1"},
            "3320": {  desc: "Zeitraum sofort",                                                         attribute: "timeRangeImmediate",                type: "number", len: "1"},
            "3321": {  desc: "Zeitraum in Monaten",                                                     attribute: "timeRangeMonths",                   type: "string", len: "1-5"},
            "3322": {  desc: "Alterskategorie",                                                         attribute: "ageCategory",                       type: "number", len: "1", mapper: "ageCategory"},
            ...
            "3473": {  desc: "Untersuchungsergebnis durch Auftragslaboratorium erstellt",               attribute: "examResultCreatedByLab",            type: "number",len: "1"},
            ...
            "4134": {  desc: "Kostentraegername",                                                       attribute: "insuranceFullName",                 type: "string", len: "<=45"},
            ...
            "4209": {  desc: "Zusätzliche Angaben zu Untersuchungen",                                                     attribute: "findings_Medication",               type: "string", len: "<=60"},
            ...
            "4229": {  desc: "Knappschaftskennziffer",                                                      attribute: "exceptionalMedIndication",          type: "number", len: "5"},
            ...
            "7336": {  desc: "Gyn. OP, Strahlen oder Chemotherapie des Genitals",                       attribute: "gynsurgRadChemo",                   type: "number",len: "1",    mapper: "noYes"},
            "7337": {  desc: "Gyn. OP, Strahlen oder Chemotherapie des Genitales – Welche?",            attribute: "gynsurgRadChemoKind",               type: "string",len: "<=60"},
            "7338": {  desc: "Gyn. OP, Strahlen oder Chemotherapie des Genitales - Wann?",              attribute: "gynsurgDate",                       type: "date", len: "8"},
            ...
            "7380": {  desc: "Ausfluss / pathologische Blutung",                                        attribute: "pathGynBleeds",                     type: "number",len: "1",    mapper: "noYes"},
            "7382": {  desc: "IUP",                                                                     attribute: "iup",                               type: "number", len: "1",   mapper: "noYes"},
            "7383": {  desc: "Einnahme von Ovulationshemmer / sonstige Hormon-Anwendung",               attribute: "ovulationInhibitor",                type: "number", len: "1",   mapper: "noYes"},
            "7384": {  desc: "Klinischer Befund",                                                       attribute: "otherHormoneTreatment",             type: "number",len: "1",    mapper: "otherHormoneTreatment"},
            ...
            "7402": {  desc: "High Risk Typ",                                                           attribute: "highRiskType",                      type: "string", len: "<=120"},
            "7403": {  desc: "Low-Risk",                                                                attribute: "lowRisk",                           type: "number", len: "1",   mapper: "positiveNegativeInvalid"},
            "7404": {  desc: "Low Risk Typ",                                                            attribute: "lowRiskType",                       type: "string", len: "<=120"},
            ...
            "7417": {  desc: "Abklärungskolposkopie",                                                   attribute: "histClarification",                 type: "number",len: "1",    mapper: "noYes"},
            ...
            "7423": {  desc: "Erläuterungen",                                                           attribute: "gynDiagnosis",                      type: "string", len: "<=990"},
            ...
            "8101": {  desc: "Abrechnungsinformationen",                                                attribute: "obj_0001Attribute",                 type: "string",len: "22",   mapper: "objTypeHeader"},
            ...
            "8109": {  desc: "Abrechnung_OEGD",                                                         attribute: "obj_0009Attribute",                 type: "string", len: "16",  mapper: "objTypeHeader"},
            ...
            "8134": {  desc: "Krebsfrueherkennung_Zervix-Karzinom",                                     attribute: "obj_0034Attribute",                 type: "string",len: "35",   mapper: "objTypeHeader"},
            ...
            "8155": {  desc: "Blutgruppenzugehoerigkeit",                                               attribute: "obj_0055Attribute",                 type: "string",len: "41",   mapper: "objTypeHeader"},
            ...
            "8162": {  desc: "\"UE_Krebsfrueherkennung_Zervix-Karzinom\"-Liste",                        attribute: "obj_0062Attribute",                 type: "string",len: "38",   mapper: "objTypeHeader"},
            ...
            "8512": {  desc: "letzte Periode",                                                          attribute: "firstDayOfLastCycle",               type: "date",len: "8",      mapper: "date"},
            ...
            "8626": {  desc: "Rechtsgrundlage der Testung",                                             attribute: "legalBasisOfTesting",               type: "number", len: "1", mapper: 'legalBasisOfTesting'  },
            "8627": {  desc: "KV-Sonderziffer",                                                         attribute: "kvSpecialNumber",                   type: "string", len: "<=5"  },
            "8629": {  desc: "Auftrag",                                                                 attribute: "order",                             type: "string", len: "<=6", mapper: 'order'  },
            "8630": {  desc: "Auftragsart",                                                             attribute: "typeOfOrder",                       type: "string", len: "1", mappper: 'typeOfOrder'  },
        ...
        ldt329.objects = {
            "Obj_0001": {
                desc: "Abrechnungsinformationen", fk: {
                    ...
                    "fk8109": {
                        amount: "1", optional: true, children: {
                            "Obj_0009": {amount: "1", optional: false}
                        }
                    }
                }
            },
            ...
            "Obj_0034": {
                desc: "Krebsfrueherkennung Zervix Karzinom (Muster 39)", fk: {
                    "fk3322": {amount: "1", optional: false},
                    ...
                    "fk7384": {amount: "1", optional: true, children: {
                            "fk3312": {amount: "1", optional: true}
                        }
                    },
                    ...
                    "fk3313": {amount: "1", optional: false},
                    "fk3314": {amount: "1", optional: false, children: {
                            "fk3315": {amount: "1", optional: true},
                            "fk3316": {amount: "1", optional: true}
                        }
                    },
                    "fk8167": {
                        amount: "n", optional: true, children: {
            ...
            "Obj_0055": {
                desc: "Blutgruppenzugehoerigkeit", fk: {
            ...
            "Obj_0062": {
                desc: "Untersuchungsergebnis Krebsfrüherkennung Zervix Karzinom", fk: {
                    "fk7304": {amount: "1", optional: false},
                    "fk7364": {amount: "n", optional: false},
                    "fk8410": {
                        amount: "1", optional: false, children: {
                    ...
                    "fk3316": {
                        amount: "1", optional: true, children: {
                            "fk3317": {amount: "1", optional: true}
                        }
                    },
                    "fk7415": {
                        amount: "1", optional: true, children: {
                            "fk7416": {amount: "n", optional: true}
                        }
                    },
                    "fk7416": {amount: "1", optional: true},
                    "fk7417": {amount: "1", optional: true},
                    "fk3318": {amount: "1", optional: true},
                    "fk3319": {amount: "1", optional: true},
                    "fk3320": {amount: "1", optional: true},
                    "fk3321": {amount: "1", optional: true},
                    "fk8237": {
                        amount: "1", optional: true, children: {
                            "Obj_0068": {amount: "1", optional: false}
                        }
        ...
        ldt329.stringMappers = {
            ...
            satzID: function( prop/*, propInfo*/ ) {
                //return [propInfo && propInfo.desc, ldt329.saetze[prop].desc];
                return [' - ' + ldt329.saetze[prop.head].desc + ' - ', undefined, true];
            },
            ...
            payerBillingArea: basicMapper( {
                "0": "Primärabrechnung",
                "1": "Sozialversicherungsabkommen (SVA)",
            ...
            ageCategory: basicMapper( {
                1: '20-29 Jahre',
                2: '30-34 Jahre',
                3: 'ab 35 Jahre'
            } ),
            hpvVaccination: basicMapper( {
                1: 'vollständig',
                2: 'unvollständig',
                3: 'keine',
                4: 'unklar'
            } ),
            hpvHrTestResult: basicMapper( {
                1: 'positiv',
                2: 'negativ',
                3: 'nicht verwertbar'
            } ),
            ...
            otherHormoneTreatment: basicMapper( {
                0: 'unauffällig',
                1: 'auffällig'
            } ),
            typeOfOrder: basicMapper( {
                'P': 'Primärscreening',
        ...
        Y.namespace( 'doccirrus.api.xdtVersions.ldt' ).ldt329 = ldt329;
