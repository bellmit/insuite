...
'use strict';
YUI.add( 'IntouchConferenceCameraBinderIndex', function( Y, NAME ) {
    ...
    function roomEntryListener( entry, roomName ) {
        ...
        if( cameraRoom === roomName && !entry ) {
            easyrtc.hangupAll();
        }
    }

    function connect( appName, userName ) {
