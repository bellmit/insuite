...
YUI.add( 'research-medications-handler', function( Y ) {
    'use strict';

    var unwrap = ko.unwrap;

    /**
     * Handle research medications action for the given patient
     *
     * @param {object} args
     * @return {*}
     */
    Y.namespace( 'doccirrus.incase.handlers' ).researchPrescription = function( args ) {
        var user = args.user;
