...
/* global YUI, ko */
YUI.add( 'InPacsLogMojitBinder', function( Y, NAME ) {
    'use strict';
    var
    ...
    Y.extend( BinderViewModel, KoViewModel.getDisposable(), {
        ...
        _initSubNavigation: function BinderViewModel__initSubNavigation() {
            var
                self = this,
                rootPath = Y.doccirrus.utils.getUrl( 'inPacsLog' ),
                router;
            ...
            self.subNavigation = KoComponentManager.createComponent( {
                ...
                componentConfig: {
                    items: [
                        {
                            name: 'tab_inpacslog_overview',
                            href: rootPath + '#/overview',
                            text: i18n( 'InpacsLogMojit.inpacsLog.subNavigation.tab_overview.title' )
                        },
                        {
                            name: 'tab_inpacslog_import',
                            href: rootPath + '#/import',
                            text: i18n( 'InpacsLogMojit.inpacsLog.subNavigation.tab_import.title' )
                        }
                    ]
                }
            } );
                ...
                routes: [
                    {
                        ...
                        callbacks: function BinderViewModel_route_root( req ) {
                            ...
                            handleTab( 'tab_inpacslog_overview' );
                        }
                    },
                    {
                        path: '/overview',
                    ...
                    },
                    {
                        ...
                        callbacks: function BinderViewModel_route_import( req ) {
                            ...
                            handleTab( 'tab_inpacslog_import' );
                        }
                    }
                ]
            } );
    ...
    Y.namespace( 'mojito.binders' )[NAME] = {
         ...
         */
        init: function InPacsLogMojitBinder_init( mojitProxy ) {
        ...
        bind: function ( node ) {
            ...
            Y.doccirrus.NavBarHeader.setActiveEntry( 'inPacsLog' );
