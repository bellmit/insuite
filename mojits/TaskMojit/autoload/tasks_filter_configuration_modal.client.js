...
YUI.add( 'tasksfilterconfigurationmodal', function( Y /*, NAME*/ ) {
        var
        ...
        Y.extend( FilterConfigurationViewModel, KoViewModel.getBase(), {
                ...
                removeConfiguration: function TabGraphicWaitingListViewModel_removeConfiguration( $context, item ) {
                    ...
                    Y.doccirrus.utils.localValueSet( 'tasksFilterConfiguration', list );
                    self.filters( list );
                }
            },
            {
                            ...
                            footer: [
                                ...
                                Y.doccirrus.DCWindow.getButton( 'OK', {
                                    ...
                                    action: function() {
                                        ...
                                        Y.doccirrus.utils.localValueSet( 'tasksFilterConfiguration', filters );
                                        self.close();
                                        callback();
                                    }
                                } )
        ...
        Y.namespace( 'doccirrus.modals' ).tasksFilterConfiguration = {
            show: show
        };
